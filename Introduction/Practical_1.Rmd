...
```{r}
![Concept Diagram](/Users/aveneri/Desktop/School/MBIO 612/Concept_Diagram.png)
```
...
`c(1, 2, 3, "Hi")`
This creates a vector containing characters.

* Would the following be valid?

`c(1, 2, 3, "Hi") + 1 `
No it would not be valid because it contains different data types.

* How about 

`c(1, 2, 3, FALSE) + 1 `
This would be valid because FALSE is a parameter of the function rather than a value in the function, so all the data in the same data type.
...
```{r}
# Write you code in this cell
x_axis <- seq(0, 10, by=0.5) #increase values by 0.5 rather than the default parameter of 1
```
...
```{r}
# Write you code in this cell
#?qplot - see what is needed for qplot
