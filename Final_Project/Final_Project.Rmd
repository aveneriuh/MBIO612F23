---
title: "Body Condition of Mother and Calf Humpback Whales (*Megoptera novaeangiliae*) Over Temporal Scales"
author: "Lewis Evans, Sophie Paradis, Maya Otsu, and Alyssa Veneri"
output: pdf_document
date: "`r Sys.Date()`"
---
...
# Data Wrangling
Below is the code used to optimize and clean the dataset used to answer the research questions.
